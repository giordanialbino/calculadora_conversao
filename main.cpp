...
{   int opcao;
    do {
        ...
        cout << "Calculadora de Conversão de bases" << endl;
        cout << "Favor digitar a opção de conversão"<< endl;
        ...
        if (opcao == 1)
        {
            ...
            for(i = 0; bin > 0; i++)
            {
                ...
                cout << "Valor de bin: "<< bin<< endl;
                cout << "Valor de dec: " << dec<< endl;
                cout << "valor de i: " << i<< endl;
                bin = bin / 10;
                cout << "Valor de bin : "<< bin<< endl;
            }
            printf("\nNúmero Decimal equivalente ao Binário: \t %d\n", dec);
